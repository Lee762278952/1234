...
static err_t low_level_init(struct netif *netif)
{
	...
	netif->hwaddr[0]=LWIP.MAC[0]; 
	netif->hwaddr[1]=LWIP.MAC[1]; 
	netif->hwaddr[2]=LWIP.MAC[2];
	netif->hwaddr[3]=LWIP.MAC[3];   
	netif->hwaddr[4]=LWIP.MAC[4];
	netif->hwaddr[5]=LWIP.MAC[5];
